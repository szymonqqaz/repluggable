...
import { MockAPI, mockPackage, mockPackageWithPublicAPI, MockPublicAPI, mockShellInitialState, mockShellStateKey } from '../testKit/mockPackage';
...
describe('App Host', function () {
    ...
    it('should create an app host', function () {
        var host = createAppHost([], testHostOptions);
    ...
    describe('AppHost Options', function () {
        ...
        it('should use custom host logger if specified', function () {
            ...
            var host = createAppHost([], options);
    ...
    describe('Packages Installation', function () {
        it('should NOT throw on circular dependency if check is disabled in host options', function () {
            var circularPackages = createDirectCircularEntryPoints();
            var hostOptionsWithDisabledCircularCheck = {
                monitoring: {},
                disableCheckCircularDependencies: true
            };
            expect(function () { return createAppHost(circularPackages, hostOptionsWithDisabledCircularCheck); }).not.toThrow();
        });
        it('should throw on direct circular API dependency (private keys)', function () {
            var circularPackages = createDirectCircularEntryPoints();
            expect(function () { return createAppHost(circularPackages, testHostOptions); }).toThrowError();
        });
        it('should throw on direct circular API dependency (public keys)', function () {
            var circularPackages = createDirectCircularEntryPoints(true);
            expect(function () { return createAppHost(circularPackages, testHostOptions); }).toThrowError();
        });
        it('should throw on circular API dependency (private keys)', function () {
            var circularPackages = createCircularEntryPoints();
            expect(function () { return createAppHost(circularPackages, testHostOptions); }).toThrowError();
        });
        it('should throw on circular API dependency (public keys)', function () {
            var circularPackages = createCircularEntryPoints(true);
            expect(function () { return createAppHost(circularPackages, testHostOptions); }).toThrowError();
        });
        it('should throw when dynamically adding a shell with circular dependency', function () {
            ...
            var circularEP = _.last(circularPackages);
            var host = createAppHost(nonCircular, testHostOptions);
            expect(function () { return host.addShells([circularEP]); }).toThrow();
        });
        it('should install initial packages', function () {
            var host = createAppHost([mockPackage], testHostOptions);
        ...
        it('should install packages after initial installations', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        host = createAppHost([], testHostOptions);
                        expect(host.hasShell(mockPackage.name)).toBe(false);
                        return [4 /*yield*/, host.addShells([mockPackage])];
                    case 1:
                        _a.sent();
                        expect(host.hasShell(mockPackage.name)).toBe(true);
                        return [2 /*return*/];
        ...
        it('should uninstall shell', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        host = createAppHost([mockPackage], testHostOptions);
                        return [4 /*yield*/, host.removeShells([mockPackage.name])];
                    case 1:
                        _a.sent();
                        expect(host.hasShell(mockPackage.name)).toBe(false);
                        return [2 /*return*/];
        ...
        it('should not install multiple shells with the same name', function () {
            expect(function () { return createAppHost([mockPackage, _.pick(mockPackage, 'name')], testHostOptions); }).toThrow();
        });
        it('should install lazy shells', function () {
            var lazyEntryPoint = makeLazyEntryPoint(mockPackage.name, function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, mockPackage];
            }); }); });
            var host = createAppHost([lazyEntryPoint], testHostOptions);
    ...
    describe('Host extension slots', function () {
        ...
        it('should retrieve all slot keys', function () {
            var sortSlotKeys = function (slotKeys) { return _.sortBy(slotKeys, 'name'); };
            var host = createAppHost([mockPackage], testHostOptions);
            var actual = sortSlotKeys(host.getAllSlotKeys());
            var expected = sortSlotKeys([AppHostAPI, mainViewSlotKey, stateSlotKey, MockAPI]);
            expect(actual).toEqual(expected);
        });
        describe('private API slot key', function () {
            it('should equal itself', function () {
                var host = createAppHost([mockPackage], testHostOptions);
                var API = host.getAPI(MockAPI);
                expect(API).toBeTruthy();
            });
            it('should not equal another key with same name', function () {
                var host = createAppHost([mockPackage], testHostOptions);
                var fakeKey = { name: MockAPI.name };
                expect(function () {
                    host.getAPI(fakeKey);
            ...
            it('should not equal another key with same name that claims it is public', function () {
                ...
                expect(function () { return host.getAPI(fakeKey1); }).toThrowError(new RegExp(MockAPI.name));
                expect(function () { return host.getAPI(fakeKey2); }).toThrowError(new RegExp(MockAPI.name));
                expect(function () { return host.getAPI(fakeKey3); }).toThrowError(new RegExp(MockAPI.name));
            });
        });
        describe('public API slot key', function () {
            it('should equal itself', function () {
                var host = createAppHost([mockPackageWithPublicAPI], testHostOptions);
                var API = host.getAPI(MockPublicAPI);
                expect(API).toBeTruthy();
            });
            ...
            it('should not equal another key with same name than does not claim it is public', function () {
                ...
                expect(function () { return host.getAPI(anotherKey1); }).toThrowError(new RegExp(MockPublicAPI.name));
                expect(function () { return host.getAPI(anotherKey2); }).toThrowError(new RegExp(MockPublicAPI.name));
                expect(function () { return host.getAPI(anotherKey3); }).toThrowError(new RegExp(MockPublicAPI.name));
            });
        });
    });
    ...
    describe('Host State', function () {
        it('should have a store with initial state', function () {
            ...
            expect(host.getStore().getState()).toEqual({
                $installedShells: {
                    installedShells: (_a = {},
                        _a[AppHostServicesEntryPointName] = true,
                        _a)
                }
            });
        });
    ...
    describe('Entry Point Contributions', function () {
        ...
        it('should contribute API after initial installations', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        host = createAppHost([], testHostOptions);
                        expect(function () { return host.getAPI(MockAPI); }).toThrow();
                        return [4 /*yield*/, host.addShells([mockPackage])];
                    case 1:
                        _a.sent();
                        expect(host.getAPI(MockAPI)).toBeTruthy();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        dependantEntryPoint = {
                            name: 'EP1',
                            getDependencyAPIs: function () { return [MockAPI]; },
                            declareAPIs: function () { return [MockAPI2]; },
                            attach: function (shell) {
                                shell.contributeAPI(MockAPI2, function () { return shell.getAPI(MockAPI); });
                            },
                        ...
                        dependantEntryPoint2 = {
                            name: 'EP2',
                            getDependencyAPIs: function () { return [MockAPI, MockAPI2]; },
                            detach: function (shell) {
                                shell.getAPI(MockAPI).stubTrue();
                                shell.getAPI(MockAPI2).stubTrue();
                            }
                        };
                        host = createAppHost([dependantEntryPoint2, mockPackage, dependantEntryPoint], testHostOptions);
                        expect(function () { return host.removeShells([mockPackage.name]); }).not.toThrow();
                        expect(host.hasShell(mockPackage.name)).toBe(false);
        ...
        it('should contribute state', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        getMockShellState = function (host) { return _.get(host.getStore().getState(), [mockPackage.name, mockShellStateKey], null); };
                        appHost = createAppHost([], testHostOptions);
                        expect(getMockShellState(appHost)).toBeNull();
                        return [4 /*yield*/, appHost.addShells([mockPackage])];
                    case 1:
                        _a.sent();
        ...
        it('should memoize functions upon demand', function () {
            var host = createAppHost([mockPackage], testHostOptions);
            var getObj = function () { return host.getAPI(MockAPI).getNewObject(); };
            expect(getObj()).not.toBe(getObj());
            var newAPI = { name: 'newAPI' };
            var createAPI = function (shell) { return ({ getNewObject: shell.memoizeForState(function () { return ({}); }, _.stubTrue) }); };
            addMockShell(host, {
        ...
        it('should not clear memoized functions if not needed', function () {
            var host = createAppHost([], testHostOptions);
            var newAPI = { name: 'newAPI' };
            var createAPI = function (shell) { return ({ getNewObject: shell.memoizeForState(function () { return ({}); }, _.stubTrue, _.stubFalse) }); };
            addMockShell(host, {
                declareAPIs: function () { return [newAPI]; },
                attach: function (shell) {
                    shell.contributeAPI(newAPI, function () { return createAPI(shell); });
    ...
    describe('Entry Point Shell Scoping', function () {
        it('should be able to call an API declared in dependencies', function () {
            ...
            var appHost = createAppHost([mockPackage], testHostOptions);
        ...
        it('should be able to uninstall own installed packages', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                expect(function () { return createAppHost([packageThatInstallsAPackage], testHostOptions); }).not.toThrow();
                return [2 /*return*/];
            });
        }); });
        it('should not be able to uninstall not own installed packages', function () {
            ...
            expect(function () { return createAppHost([mockPackage, packageThatTriesToUninstallAPackage], testHostOptions); }).toThrow();
        });
    });
    describe('Entry Point HMR support', function () {
        ...
        it('should be able to reload entry points', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        appHost = createAppHost(hmrTestPackage, testHostOptions);
    ...
    describe('API layer', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        host = createAppHost([], __assign(__assign({}, emptyLoggerOptions), { layers: layers }));
                        EntryPoint1 = {
        ...
        it('should not allow adding shell of unknown layer', function () {
            ...
            var host = createAppHost([], __assign(__assign({}, emptyLoggerOptions), { layers: layers }));
            var EntryPoint1 = {
                name: 'MOCK_ENTRY_POINT_1',
        ...
        it('should support multi dimensional layers definition', function () {
            ...
            var host = createAppHost([], __assign(__assign({}, emptyLoggerOptions), { layers: [layersDimension1, layersDimension2] }));
            var EntryPoint1 = {
                name: 'MOCK_ENTRY_POINT_1',
                layer: ['INFRA', 'COMMON'],
                declareAPIs: function () { return [MockAPI1]; },
        ...
        it('should enforce cross-multi-dimensional-layers name uniqueness', function () {
            ...
            expect(function () {
                return createAppHost([], __assign(__assign({}, emptyLoggerOptions), { layers: [layersDimension1, layersDimension2] }));
        ...
        it('should allow single layered API for multi dimensional layers host', function () {
            ...
            expect(function () {
                return createAppHost([EntryPoint1, EntryPoint2], __assign(__assign({}, emptyLoggerOptions), { layers: [layersDimension1, layersDimension2] }));
            }).not.toThrow();
        });
    });
        ...
        it('should get all entry points', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        host = createAppHost([mockPackage], testHostOptions);
                        return [4 /*yield*/, host.addShells([mockPackageWithPublicAPI])];
                    case 1:
                        _a.sent();
                        allEntryPoints = host.getAPI(AppHostAPI).getAllEntryPoints();
                        expect(_.sortBy(allEntryPoints, 'name')).toEqual(_.sortBy([mockPackage, mockPackageWithPublicAPI, host.getAppHostServicesShell().entryPoint], 'name'));
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('Cyclic Mode', function () {
        it('should load cyclic dependencies groups if all other dependencies are ready', function () {
            ...
            var host = createAppHost(entryPoints, __assign(__assign({}, testHostOptions), { experimentalCyclicMode: true }));
