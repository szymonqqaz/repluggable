...
var interceptEntryPoints_1 = require("../src/interceptEntryPoints");
var testKit_1 = require("../testKit");
function takeLog(spy) {
    return lodash_1.default.flatten(spy.mock.calls);
}
...
describe('interceptEntryPoints', function () {
    it('should intercept name', function () {
        ...
        var intercepted = interceptEntryPoints_1.interceptEntryPoints(entryPoints, interceptor);
    ...
    it('should allow multiple interceptors', function () {
        ...
        var intercepted1 = interceptEntryPoints_1.interceptEntryPoints(entryPoints[0], interceptor1);
        var intercepted2 = interceptEntryPoints_1.interceptEntryPoints(intercepted1, interceptor2);
    ...
    it('should apply single interceptor to map of entry points', function () {
        ...
        var interceptedMap = interceptEntryPoints_1.interceptEntryPointsMap(packagesMap, interceptor);
        var intercepted = [
    ...
    it('should apply multiple interceptors to map of entry points', function () {
        ...
        var interceptor1 = createTestInterceptor(spy, 'I1', { interceptAttach: true });
        var interceptor2 = createTestInterceptor(spy, 'I2', { interceptAttach: true });
        var interceptedMap1 = interceptEntryPoints_1.interceptEntryPointsMap(packagesMap, interceptor1);
        var interceptedMap2 = interceptEntryPoints_1.interceptEntryPointsMap(interceptedMap1, interceptor2);
        var intercepted = [
    ...
    it('should be able to add intercepted entry point to AppHost', function () {
        ...
        var intercepted = interceptEntryPoints_1.interceptEntryPoints(entryPoints, interceptor);
        testKit_1.createAppHost(intercepted, {
            monitoring: {}
        });
        // getDependencyAPIs appears to be called multiple times
        expect(lodash_1.default.uniq(takeLog(spy))).toEqual([
            'EP-0:declareAPIs',
...
function createTestEntryPoints(count, spy) {
    return lodash_1.default.times(count).map(function (index) { return ({
        name: "EP-" + index,
