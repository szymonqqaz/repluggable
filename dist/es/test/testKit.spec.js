...
import { getPackagesDependencies, createAppHost, addMockShell, MockAPI, mockPackage, createAppHostWithPacts } from '../testKit';
var APIs = {
    A: { name: 'A' },
    B: { name: 'B' },
    C: { name: 'C' },
...
describe('App Host TestKit', function () {
    it('should get packages dependencies', function () {
        var toResult = function (packages) { return _(packages).flatten().sortBy('name').value(); };
        var getDependencies = function (packages) { return toResult(getPackagesDependencies(_.values(allPackages), packages)); };
    ...
    it('should add mock shell', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            host = createAppHost([mockPackage]);
            shell = addMockShell(host, {
                name: 'MOCK',
                getDependencyAPIs: function () {
                    return [MockAPI];
                }
            ...
            expect(function () { return shell.getAPI(MockAPI); }).not.toThrow();
            return [2 /*return*/];
        });
    }); });
    ...
    it('should create app host with provided pacts', function () {
        ...
        var host = createAppHostWithPacts([], [pactAPI]);
