...
var getMockShellState = function (host) { return lodash_1.default.get(host.getStore().getState(), [testKit_1.mockPackage.name], null); };
var getValueFromState = function (state) { return "" + state[testKit_1.mockShellStateKey].mockValue; };
var createMocks = function (entryPoint, moreEntryPoints) {
    ...
    var wrappedPackage = __assign(__assign({}, entryPoint), { attach: function (shell) {
            lodash_1.default.invoke(entryPoint, 'attach', shell);
            cachedShell = shell;
        } });
    var host = testKit_1.createAppHost(__spreadArray([wrappedPackage], __read(moreEntryPoints)), testKit_1.withThrowOnError());
    var getShell = function () { return cachedShell; };
    return {
        host: host,
        shell: getShell(),
        renderInShellContext: function (reactElement) { return testKit_1.renderInHost(reactElement, host, getShell()); }
    };
};
describe('connectWithShell', function () {
    it('should pass exact shell to mapStateToProps', function () {
        var _a = createMocks(testKit_1.mockPackage), shell = _a.shell, renderInShellContext = _a.renderInShellContext;
        var PureComp = function (_a) {
            var shellName = _a.shellName;
            return react_1.default.createElement("div", null, shellName);
        };
        var mapStateToProps = function (s) { return ({ shellName: s.name }); };
        var ConnectedComp = testKit_1.connectWithShell(mapStateToProps, undefined, shell)(PureComp);
        var comp = renderInShellContext(react_1.default.createElement(ConnectedComp, null)).parentWrapper;
        expect(comp && comp.text()).toBe(testKit_1.mockPackage.name);
    });
    it('should pass exact shell to mapDispatchToProps', function () {
        ...
        var ConnectedComp = testKit_1.connectWithShell(undefined, mapDispatchToProps, shell)(PureComp);
        var comp = renderInShellContext(react_1.default.createElement(ConnectedComp, null)).parentWrapper;
        expect(comp && comp.text()).toBe(testKit_1.mockPackage.name);
    });
    it('should optimize props comparison', function () {
        var _a = createMocks(testKit_1.mockPackage), host = _a.host, shell = _a.shell, renderInShellContext = _a.renderInShellContext;
        var func1 = jest.fn();
        var func2 = jest.fn();
        ...
        var PureComp = function (_a) {
            ...
            renderSpy();
            return react_1.default.createElement("div", { onClick: func }, JSON.stringify(obj));
        };
        var ConnectedComp = testKit_1.connectWithShell(mapStateToProps, undefined, shell)(PureComp);
        var root = renderInShellContext(react_1.default.createElement(ConnectedComp, null)).root;
        if (!root) {
            throw new Error('Connected component fail to render');
        }
        expect(root.find(ConnectedComp).text()).toBe('{"a":1}');
        expect(renderSpy).toHaveBeenCalledTimes(1);
        update(root, lodash_1.default.cloneDeep(props));
        expect(renderSpy).toHaveBeenCalledTimes(1);
    ...
    it('should avoid mapping state with should update', function () {
        ...
        var ConnectedComp = testKit_1.connectWithShell(mapStateToProps, undefined, shell, { shouldComponentUpdate: function () { return false; } })(PureComp);
        var root = renderInShellContext(react_1.default.createElement(ConnectedComp, null)).root;
        if (!root) {
            throw new Error('Connected component fail to render');
        }
    ...
    it('should pass scoped state to mapStateToProps', function () {
        ...
        var PureCompNeedsState = function (_a) {
            ...
            return react_1.default.createElement("div", null, valueFromState);
        };
        var mapStateToProps = function (s, state) { return ({
            valueFromState: getValueFromState(state)
        }); };
        var ConnectedWithState = testKit_1.connectWithShell(mapStateToProps, undefined, shell)(PureCompNeedsState);
        var withConnectedState = renderInShellContext(react_1.default.createElement(ConnectedWithState, null)).parentWrapper;
    ...
    it('should bind shell context', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = createMocks(testKit_1.mockPackage), host = _a.host, renderInShellContext = _a.renderInShellContext;
                    ...
                    otherEntryPoint = {
                        ...
                        attach: function (shell) {
                            shell.contributeState(function () {
                                var _a;
                                return (_a = {},
                                    _a[testKit_1.mockShellStateKey] = function () { return boundShellState; },
                                    _a);
                            });
                ...
                case 1:
                    ...
                    ConnectedWithState = testKit_1.connectWithShell(mapStateToProps, undefined, getBoundShell())(PureComp);
                    withConnectedState = renderInShellContext(react_1.default.createElement(ConnectedWithState, null)).parentWrapper;
    ...
    it('should re-provide shell context for children of bound component', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = createMocks(testKit_1.mockPackage), host = _a.host, shell = _a.shell, renderInShellContext = _a.renderInShellContext;
                    cachedBoundShell = null;
                    boundShellState = { mockValue: 'bound-value' };
                    otherEntryPoint = {
                        name: 'bound',
                ...
                case 1:
                    ...
                    PureCompWithChildren = function (_a) {
                        ...
                        return (react_1.default.createElement("div", { id: id, "data-value": value }, children));
                    };
                    mapStateToProps = function (s, state) { return ({
                        value: getValueFromState(state)
                    }); };
                    ConnectedUnboundComp = testKit_1.connectWithShell(mapStateToProps, undefined, shell)(PureComp);
                    ConnectedUnboundCompWithChildren = testKit_1.connectWithShell(mapStateToProps, undefined, shell)(PureCompWithChildren);
                    ConnectedBoundCompWithChildren = testKit_1.connectWithShell(mapStateToProps, undefined, getBoundShell())(PureCompWithChildren);
                    withConnectedState = renderInShellContext(react_1.default.createElement(ConnectedUnboundCompWithChildren, { id: "A" },
                        react_1.default.createElement(ConnectedBoundCompWithChildren, { id: "B" },
                            react_1.default.createElement(ConnectedUnboundComp, null)))).parentWrapper;
    ...
    it('should render contributed boundary aspect', function () {
        ...
        var _a = createMocks({
            ...
            attach: function (myShell) {
                myShell.contributeBoundaryAspect(function (props) { return react_1.default.createElement("div", { className: "TEST-ASPECT" }, props.children); });
            }
        }), host = _a.host, shell = _a.shell;
        var PureComp = function () { return react_1.default.createElement("div", { className: "TEST-PURE-COMP" }, "TEST"); };
        var ConnectedComp = testKit_1.connectWithShell(undefined, undefined, shell)(PureComp);
        // act
        var result = testKit_1.renderInHost(react_1.default.createElement(ConnectedComp, null), host, shell);
        // assert
    ...
    it('should render multiple contributed boundary aspects', function () {
        ...
        var _a = createMocks({
            name: 'ASPECT-TEST-EP',
            attach: function (myShell) {
                myShell.contributeBoundaryAspect(function (props) { return react_1.default.createElement("div", { className: "TEST-ASPECT-A" }, props.children); });
                myShell.contributeBoundaryAspect(function (props) { return react_1.default.createElement("div", { className: "TEST-ASPECT-B" }, props.children); });
            }
        }), host = _a.host, shell = _a.shell;
        var PureComp = function () { return react_1.default.createElement("div", { className: "TEST-PURE-COMP" }, "TEST"); };
        var ConnectedComp = testKit_1.connectWithShell(undefined, undefined, shell)(PureComp);
    ...
    it('should handle boundary aspect contexts', function () {
        // arrange
        var TestAspectContext = react_1.default.createContext({ theNumber: 0 });
        var _a = createMocks({
            name: 'ASPECT-TEST-EP',
            attach: function (myShell) {
                myShell.contributeBoundaryAspect(function (props) { return (react_1.default.createElement("div", { className: "TEST-ASPECT" },
                    react_1.default.createElement(TestAspectContext.Provider, { value: { theNumber: 123 } }, props.children))); });
            }
        }), host = _a.host, shell = _a.shell;
        var PureComp = function () { return (react_1.default.createElement(TestAspectContext.Consumer, null, function (aspect) { return react_1.default.createElement("div", { className: "TEST-PURE-COMP" }, aspect.theNumber); })); };
        var ConnectedComp = testKit_1.connectWithShell(undefined, undefined, shell)(PureComp);
        // act
        var result = testKit_1.renderInHost(react_1.default.createElement(ConnectedComp, null), host, shell);
        // assert
...
describe('connectWithShell-useCases', function () {
    ...
    var PureComp = function (_a) {
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("div", { id: "ONE" }, valueOne),
            react_1.default.createElement("div", { id: "TWO" }, valueTwo),
            react_1.default.createElement("div", { id: "THREE" }, valueThree)));
    };
    ...
    it('should update component through observer', function () {
        ...
        var ConnectedComp = testKit_1.connectWithShellAndObserve({
