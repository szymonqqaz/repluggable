...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    function ErrorBoundary(props) {
        ...
        _this.throttledResetError = _.throttle(function () {
            _this.resetError();
        }, 500, { leading: true });
        _this.state = {
            hasError: false,
    ...
    ErrorBoundary.prototype.render = function () {
        ...
        if (this.state.hasError) {
            ...
            if (enableStickyErrorBoundaries) {
                return (React.createElement("div", { className: "component-error " + (this.props.errorClassName || ''), style: { pointerEvents: 'all' }, title: this.state.errorMessage || '(unknown error)' },
                    "error in ",
                    React.createElement("b", null, qualifiedName),
                    React.createElement("button", { onClick: function () { return _this.resetError(); } }, "reset")));
            }
            return null;
        }
