...
var interceptAnyObject_1 = require("../src/interceptAnyObject");
...
describe('interceptAnyObject', function () {
    ...
    it('should return same members if no interceptors passed', function () {
        ...
        var intercepted = interceptAnyObject_1.interceptAnyObject(real);
    ...
    it('should intercept void functions', function () {
        var spy = jest.fn();
        var real = createTestTarget(spy);
        var intercepted = interceptAnyObject_1.interceptAnyObject(real, createFuncInterceptor(spy));
    ...
    it('should intercept scalar props', function () {
        var spy = jest.fn();
        var real = createTestTarget(spy);
        var intercepted = interceptAnyObject_1.interceptAnyObject(real, createFuncInterceptor(spy), createPropInterceptor(spy));
    ...
    it('should intercept nested objects', function () {
        var spy = jest.fn();
        var real = createTestTarget(spy);
        var intercepted = interceptAnyObject_1.interceptAnyObject(real, createFuncInterceptor(spy), createPropInterceptor(spy), 10);
